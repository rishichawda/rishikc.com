...
export default function Projects() {
  return (
    <section className="container project-section">
      ...
      <p>
        You can check out all other{' '}
        <a aria-label="Link to Github Profile" href="https://www.github.com/rishichawda">
          github repositories
        </a>{' '}
        on my profile.
      </p>
      <div className="inner-container">
        ...
        >
          <article className="card lang-js">
            ...
            <div className="repo-description">
              <p>
                🎊 A plugin to update your branch badges to point to correct branch status. Can be used in a script, as
                a git hook or directly from the command line itself!
              </p>
            </div>
          </article>
        </OutboundLink>
        ...
        >
          <article className="card lang-js">
            ...
            <div className="repo-description">
              <p>
                Simple typeracer app with less distractions and funny auto generated texts. A simple two-hour
                programming gig done on a lazy weekend. Don't expect much!! :)
              </p>
            </div>
          </article>
        </OutboundLink>
        ...
        >
          <article className="card lang-js">
            ...
            <div className="repo-description">
              <p>
                Cross platform reminders and notes application for Mac, Linux and Windows. Built with ElectronJS and
                boredom. <br />
                <br />
                🚧 Work in progress.
              </p>
