  ...
  <section className="container about-section hidden">
    <div className="about-section-inner">
      <div role="main" aria-labelledby="about-me about-me" className="about-content">
        ...
        <p>
          I design and develop websites, progressive web applications and native mobile applications for Android and
          iOS.
        </p>
        <p>
          Apart from good food, traveling, music and art - I am interested in search engine optimisation, analytics,
