      ...
      <Container>
        ...
        <AboutSection>
          <picture>
            ...
            <NiceImage alt="rishi_kumar_chawda" src={niceImage} />
          </picture>
          <AboutText>
            <ContentText>
              I'm a web and mobile application developer. I was born in the 90s' - when tech had
              started becoming popular among young people, I spent most of my childhood playing
              video games. After graduating from high school, I enrolled for a Bachelors' degree in
              Computer Science and fell in love with programming during that time. Since then, I've
              been programming in different languages.
            </ContentText>
            <ContentText>
              I design and develop websites, progressive web applications, and hybrid mobile
              applications for Android and iOS. I also like working on search engine optimization,
